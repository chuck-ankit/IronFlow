const workouts = {
  Monday: {
    ...
    exercises: [
      ...
      { id: "mon-2", name: "Incline Dumbbell Press", sets: "4x8-10" },
      { id: "mon-3", name: "Machine Chest Press", sets: "3x10-12" },
      { id: "mon-4", name: "Cable Fly", sets: "3x12-15" },

      { id: "mon-5", name: "Seated DB Shoulder Press", sets: "4x8" },
      { id: "mon-6", name: "Lateral Raises", sets: "5x15" },

      { id: "mon-7", name: "Skull Crushers", sets: "4x10" },
      { id: "mon-8", name: "Rope Pushdown", sets: "4x12" },

      { id: "mon-9", name: "Incline Walk", sets: "15 min cardio" }
    ]
  },

  Tuesday: {
    title: "Pull (Back Thickness + Forearms)",
    exercises: [
      { id: "tue-1", name: "Deadlift", sets: "5x5" },
      { id: "tue-2", name: "Pull-ups / Assisted", sets: "4 sets" },
      { id: "tue-3", name: "Barbell Row", sets: "4x8" },
      { id: "tue-4", name: "Seated Cable Row", sets: "4x10-12" },
      { id: "tue-5", name: "Straight Arm Pulldown", sets: "3x15" },

      { id: "tue-6", name: "Barbell Curl", sets: "4x8-10" },
      { id: "tue-7", name: "Incline DB Curl", sets: "4x10-12" },
      { id: "tue-8", name: "Hammer Curl", sets: "4x12" },

      { id: "tue-9", name: "Reverse EZ Curl", sets: "3x15" },
      { id: "tue-10", name: "Dead Hang", sets: "3x30-60 sec" },

      { id: "tue-11", name: "Incline Walk", sets: "15 min cardio" }
    ]
  },
  ...
  Thursday: {
    ...
    exercises: [
      ...
      { id: "thu-4", name: "Lean Away Cable Lateral Raise", sets: "3x15" },
      { id: "thu-5", name: "Rear Delt Fly", sets: "5x15" },

      { id: "thu-6", name: "Decline Pushups", sets: "4 sets" },

      { id: "thu-7", name: "Triceps FST-7 Rope Pushdown", sets: "7x10-12" },

      { id: "thu-8", name: "Mountain Climbers HIIT", sets: "30s + 60s x10" }
    ]
  },

  Friday: {
    title: "Pull (Lat + Arm Specialization)",
    exercises: [
      ...
      { id: "fri-4", name: "Preacher Curl", sets: "4x10-12" },
      { id: "fri-5", name: "FST-7 Cable Curl", sets: "7x12" },

      { id: "fri-6", name: "FST-7 Overhead Rope Extension", sets: "7x12" },

      { id: "fri-7", name: "Wrist Curl", sets: "3x20" },
      { id: "fri-8", name: "Reverse Wrist Curl", sets: "3x20" },

      { id: "fri-9", name: "Incline Walk", sets: "20 min cardio" }
    ]
  },
  ...
  Saturday: {
    ...
    exercises: [
      ...
      { id: "sat-5", name: "Adductor Machine", sets: "4x15" },

      { id: "sat-6", name: "Conditioning Circuit", sets: "3-4 rounds" },
      { id: "sat-7", name: "Incline Walk Fast", sets: "1 min" },
      { id: "sat-8", name: "Dumbbell Punches", sets: "40 sec" },
      { id: "sat-9", name: "Dumbbell Swings", sets: "20 reps" },
      { id: "sat-10", name: "Jump Rope / High Knees", sets: "1 min" },
      { id: "sat-11", name: "Mountain Climbers", sets: "30 sec" }
    ]
  },
